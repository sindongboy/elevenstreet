...
//			    String hdfsPath = "hdfs://172.21.1.192:8020";
			    
		//	    String hdfsPath = "hdfs://192.168.99.100:50010";
...
//		conf.addResource(new Path(classLoader.getResource("core-site.xml").getFile()));
//		conf.addResource(new Path(classLoader.getResource("hdfs-site.xml").getFile()));
...
//
		client.addFile("/Users/skplanet/tail", "test");

		client.readFile("test/tail");
